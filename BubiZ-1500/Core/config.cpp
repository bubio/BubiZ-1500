...
void initialize_config()
{
	...
	#endif
	config.window_aspect_mode = 1;  // Default: 640x480
	...
	#endif
	config.sound_speaker_simulation = false;
	config.sound_reverb = false;
	config.sound_chorus = false;
...
void load_config(const _TCHAR* config_path)
{
	...
	// screen
		...
		config.window_aspect_mode = MyGetPrivateProfileInt(_T("Screen"), _T("WindowAspectMode"), config.window_aspect_mode, config_path);
...
//		#endif
	...
	#endif
	config.sound_speaker_simulation = MyGetPrivateProfileBool(_T("Sound"), _T("SpeakerSimulation"), config.sound_speaker_simulation, config_path);
	config.sound_reverb = MyGetPrivateProfileBool(_T("Sound"), _T("Reverb"), config.sound_reverb, config_path);
	config.sound_chorus = MyGetPrivateProfileBool(_T("Sound"), _T("Chorus"), config.sound_chorus, config_path);
...
void save_config(const _TCHAR* config_path)
{
	...
	// screen
		...
		MyWritePrivateProfileInt(_T("Screen"), _T("WindowAspectMode"), config.window_aspect_mode, config_path);
...
//		#endif
	...
	#endif
	MyWritePrivateProfileBool(_T("Sound"), _T("SpeakerSimulation"), config.sound_speaker_simulation, config_path);
	MyWritePrivateProfileBool(_T("Sound"), _T("Reverb"), config.sound_reverb, config_path);
	MyWritePrivateProfileBool(_T("Sound"), _T("Chorus"), config.sound_chorus, config_path);
	#ifdef USE_SOUND_VOLUME
		for(int i = 0; i < USE_SOUND_VOLUME; i++) {
