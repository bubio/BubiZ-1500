...
void MZ1P17::draw_char(uint16_t code)
{
	...
	if(IS_KANA(code) && hiragana_mode) {
		static const uint16_t hiragana_sjis[] = {
			...
			0x82bd, 0x82bf, 0x82c2, 0x82c4, 0x82c6,	// �����Ă�
			0x82c8, 0x82c9, 0x82ca, 0x82cb, 0x82cc,	// �Ȃɂʂ˂�
			0x82cd, 0x82d0, 0x82d3, 0x82d6, 0x82d9,	// �͂Ђӂւ�
			0x82dc, 0x82dd, 0x82de, 0x82df, 0x82e0,	// �܂݂ނ߂�
